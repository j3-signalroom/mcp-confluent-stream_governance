...
class Metadata(ObjectMeta):
    self: Optional[Any] = Field(
        None, example='https://api.confluent.cloud/tableflow/v1/regions/r-12345'
    )
...
class Region(BaseModel):
    ...
    region: Optional[str] = Field(
        None, description='The cloud service provider region.', example='us-east-2'
    )


class Kind1Model(Enum):
    TableflowTopic = 'TableflowTopic'
...
class ByobAwsSpec(BaseModel):
    ...
    bucket_name: str = Field(..., description='Bucket name', example='bucket_1')
    bucket_region: Optional[str] = Field(
        None, description='Bucket region', example='us-east-1'
    )
    provider_integration_id: str = Field(
        ..., description='The provider integration id', example='cspi-stgce89r7'
    )
...
class CatalogIntegrationUnitySpec(BaseModel):
    kind: Literal['Unity'] = Field(
        ..., description='The type of the catalog integration.'
    )
    workspace_endpoint: str = Field(
        ...,
...
class CatalogIntegrationUnityUpdateSpec(BaseModel):
    kind: Literal['Unity'] = Field(
        ..., description='The type of the catalog integration.'
    )
    workspace_endpoint: Optional[str] = Field(
        None,
        description='The Databricks workspace URL associated with the Unity Catalog.',
        example='https://user1.cloud.databricks.com',
    )
    catalog_name: Optional[str] = Field(
        None, description='The name of the catalog within Unity Catalog.'
    )
    client_id: Optional[str] = Field(
        None,
        description='The OAuth client ID used to authenticate with the Unity Catalog.',
...
class Kind1Model10(Enum):
    CatalogIntegrationUpdateRequest = 'CatalogIntegrationUpdateRequest'
...
class CatalogIntegrationUpdateSpec(BaseModel):
    ...
    config: Optional[
        Union[
            CatalogIntegrationAwsGlueUpdateSpec,
            CatalogIntegrationSnowflakeUpdateSpec,
            CatalogIntegrationUnityUpdateSpec,
        ]
...
class Metadata1Model3(ListMeta):
    first: Optional[Any] = Field(
        None, example='https://api.confluent.cloud/tableflow/v1/regions'
    )
...
class Kind1Model12(Enum):
    TableflowTopicList = 'TableflowTopicList'


class Metadata1Model4(ListMeta):
    first: Optional[Any] = Field(
        None, example='https://api.confluent.cloud/tableflow/v1/tableflow-topics'
    )
    last: Optional[Any] = Field(
        None,
...
class Kind1Model13(Enum):
    CatalogIntegrationList = 'CatalogIntegrationList'


class Metadata1Model5(ListMeta):
    first: Optional[Any] = Field(
        None, example='https://api.confluent.cloud/tableflow/v1/catalog-integrations'
    )
    last: Optional[Any] = Field(
        None,
...
class CatalogIntegrationSpec(BaseModel):
    ...
    config: Optional[
        Union[
            CatalogIntegrationAwsGlueSpec,
            CatalogIntegrationSnowflakeSpec,
            CatalogIntegrationUnitySpec,
        ]
    ] = Field(None, description='The integration config', discriminator='kind')
    environment: Optional[GlobalObjectReference] = Field(
        None, description='The environment to which the target Kafka cluster belongs.'
...
class TableflowTopicUpdate(BaseModel):
    ...
    kind: Optional[Kind1Model14] = Field(
        None, description='Kind defines the object this REST resource represents.'
    )
