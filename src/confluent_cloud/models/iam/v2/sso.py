...
class Metadata(ObjectMeta):
    self: Optional[Any] = Field(
        None, example='https://api.confluent.cloud/iam.v2/sso/group-mappings/gm-12345'
    )
...
class GroupMapping(BaseModel):
    ...
    state: Optional[str] = Field(
        None, description='The current state of the group mapping.', example='ENABLED'
    )


class Kind1Model(Enum):
    GroupMappingList = 'GroupMappingList'


class Metadata1Model(ListMeta):
    first: Optional[Any] = Field(
        None, example='https://api.confluent.cloud/iam.v2/sso/group-mappings'
    )
