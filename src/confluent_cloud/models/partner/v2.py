...
class Entitlement(BaseModel):
    ...
    name: Optional[str] = Field(
        None, description='The name of the entitlement', example='Acme Prod Entitlement'
    )
...
class EntitlementList(BaseModel):
    ...
    metadata: ListMeta
    data: List[Entitlement] = Field(..., unique_items=True)
...
class Organization(BaseModel):
    ...
    metadata: Optional[ObjectMeta] = None
    name: Optional[constr(regex=r'^[^<>#%\'*^`{|}~\"]{1,31}$')] = Field(
        None, description='The name of the organization', example='Acme Organization'
    )
...
class OrganizationList(BaseModel):
    ...
    metadata: ListMeta
    data: List[Organization] = Field(..., unique_items=True)
