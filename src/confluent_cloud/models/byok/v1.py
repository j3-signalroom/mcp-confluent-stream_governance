...
class Metadata(ObjectMeta):
    self: Optional[Any] = Field(
        None, example='https://api.confluent.cloud/byok/v1/keys/cck-12345'
    )
...
class KeyValidation(BaseModel):
    ...
    since: datetime = Field(
        ...,
        description='The timestamp since which the key is in the current validation phase.\nChanges to the validation message or phase will update this timestamp.\n',
        example='2024-03-20T15:30:00Z',
    )
    region: Optional[str] = Field(
        None,
        description='The cloud region where the key is deployed. This value is computed by the\nAPI after the key is successfully validated.\n',
        example='us-west-2',
    )
...
class Metadata1Model(ListMeta):
    first: Optional[Any] = Field(
        None, example='https://api.confluent.cloud/byok/v1/keys'
    )
...
class KeyUpdate(BaseModel):
    ...
    provider: Optional[str] = Field(
        None, description='The cloud provider of the Key.', example='AWS'
    )
    ...
    validation: Optional[KeyValidation] = Field(
        None, description='The validation details of the key.\n'
    )
