...
class Metadata(ObjectMeta):
    self: Optional[Any] = Field(
        None, example='https://api.confluent.cloud/org/v2/environments/e-12345'
    )
...
class MetadataModel(ObjectMeta):
    self: Optional[Any] = Field(
        None, example='https://api.confluent.cloud/org/v2/organizations/o-12345'
    )
    resource_name: Optional[Any] = Field(
        None, example='crn://confluent.cloud/organization=o-12345'
    )
...
class Organization(BaseModel):
    ...
    display_name: Optional[constr(regex=r'^[^<>#%\'*^`{|}~\"]{1,31}$')] = Field(
        None,
...
class MetadataModel1(ListMeta):
    first: Optional[Any] = Field(
        None, example='https://api.confluent.cloud/org/v2/environments'
    )
...
class MetadataModel2(ListMeta):
    first: Optional[Any] = Field(
        None, example='https://api.confluent.cloud/org/v2/organizations'
    )
    last: Optional[Any] = Field(
        None,
