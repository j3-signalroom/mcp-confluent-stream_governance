...
class Environment(BaseModel):
    id: Optional[str] = Field(
        None, description='ID of the environment.', example='env-123'
    )
...
class Resource(BaseModel):
    id: Optional[str] = Field(
        None, description='ID of the resource.', example='lkc-12345'
    )
    display_name: Optional[str] = Field(
        None, description='Display name of the resource.', example='prod-kafka-cluster'
    )
...
class Cost(BaseModel):
    ...
    network_access_type: Optional[str] = Field(
        None, description='Network access type for the cluster.', example='INTERNET'
    )
    product: Optional[str] = Field(None, description='Product name.', example='KAFKA')
    line_type: Optional[str] = Field(
        None, description='Type of the line item.', example='KAFKA_NUM_CKUS'
    )
    price: Optional[float] = Field(
        None, description='Price for the line item in dollars.', example=1.5
    )
    unit: Optional[str] = Field(
        None, description='Unit of the line item.', example='GB'
    )
    quantity: Optional[float] = Field(
        None, description='Quantity of the line item.', example=99.9
    )
    original_amount: Optional[float] = Field(
        None, description='Original amount accrued for this line item.', example=149.85
    )
    ...
    amount: Optional[float] = Field(
        None, description='Final amount after deducting discounts.', example=129
    )
