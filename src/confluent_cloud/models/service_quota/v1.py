...
class MetadataModel(ObjectMeta):
    self: Optional[Any] = Field(
        None, example='https://api.confluent.cloud/service-quota/v1/scopes/s-12345'
    )
    resource_name: Optional[Any] = Field(
        None,
...
class KindModel1(Enum):
    AppliedQuotaList = 'AppliedQuotaList'


class MetadataModel1(ListMeta):
    first: Optional[Any] = Field(
        None, example='https://api.confluent.cloud/service-quota/v1/applied-quotas'
    )
...
class MetadataModel2(ListMeta):
    first: Optional[Any] = Field(
        None, example='https://api.confluent.cloud/service-quota/v1/scopes'
    )
    last: Optional[Any] = Field(
        None,
